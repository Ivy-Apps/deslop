{- | The outcome of a completed run: what it covered, and whether it found
anything the user must act on.

Rendering one for a human is "UI.summaryLine" and "UI.problemsFoundText".
-}
module Deslop.RunReport (
    RunReport (..),
    RunSummary (..),
    Verdict (..),
    ProblemCounts (..),
