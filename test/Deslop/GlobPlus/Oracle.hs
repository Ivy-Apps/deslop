...
What is /not/ re-implemented here is the casing layer: 'Deslop.GlobPlus.Casing.decodings'
and 'Deslop.GlobPlus.Casing.spells' are used as given. That layer is unchanged by this
...
import Deslop.GlobPlus.Casing (Casing (..), decodings, render, spells)
import Hedgehog (Gen)
...
question 'Deslop.GlobPlus.Casing.agree' answers, asked here without reference to how
...
Written by hand rather than by calling 'Deslop.GlobPlus.Casing.renderings', so that a
